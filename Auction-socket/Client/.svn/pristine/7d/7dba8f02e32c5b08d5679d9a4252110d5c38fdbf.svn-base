...
public class SellerTab extends CustomPanel implements Observer {
	...
	private SellerTable tableModel = null;
	private CustomButton button_refresh;
	...
	public SellerTab(Socket socket) {
		...
		CustomLabel label_time = new CustomLabel("Duration");
		...
		button_confirm.setBounds(34, 480, 120, 31);
		...
		button_confirm.addActionListener(ae -> {
			...
			if (!text_name.getText().equals("")) {
				...
				JOptionPane.showMessageDialog(null, "Item name should not be null", "alert",
		...
		button_close.setBounds(700, 480, 150, 31);
		...
		button_refresh.setBounds(860, 480, 110, 31);
		...
		add(s_pan);
		s_pan.setBounds(210, 55, 760, 420);
