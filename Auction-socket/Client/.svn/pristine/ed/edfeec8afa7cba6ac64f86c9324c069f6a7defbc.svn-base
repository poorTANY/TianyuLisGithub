...
public class RegisterModel extends Observable {
	...
	/**
	 * simple version of sending the information of user to the server in this
	 * version, only username and password are send more information will be
	 * added in the future according to what information we will have for a user
	 * profile
	 * 
	 * @param username
	 * @param password
	...
	public boolean register(String username, String password) {
		try {
			...
			if (result[1].equals("true")) {
				...
				// password!", "request rejected", JOptionPane.ERROR_MESSAGE);
				return false;
			}
		} catch (IOException e) {
