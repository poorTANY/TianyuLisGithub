/************************************************************
 ...
 FileName: 3.approximate_dp_implicit_links.cpp
 Author: Tianyu Li
 Description: approcimate dynamic programming solution for implicit links
 Function List:
 1.readFile() //read graph data from script
 2.init() // pre-calculate and initialise data
 3.solve() // the best solution
 History:
